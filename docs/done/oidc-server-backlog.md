...
> Historical note: This file is kept as a completed planning and tracking artifact. Milestone status, runtime notes, and architecture comments reflect the repo state when this backlog was active. For current guidance, use [README](../../README.md), [docs/index.md](../index.md), and [docs/developer-guide.md](../developer-guide.md).
