...
2. **Roles Section** (~5 files: Index, Add, Edit)
3. **Scopes Section** (~3 files: Index, Add, Edit)
4. **Settings** (1 file)
5. **Registrations** (Index.cshtml.cs)

**Estimated Total:** ~30-40 additional redirects need fixing
