...
- `/Auth/Logout` lets the user choose between signing out only of this Razor app or federating the sign-out with the issuer using the configured client registration.
