...
iteration: 2
sequence: 14
timestamp: 2026-02-03T14:36:45.8888352Z
---
...
## ⚠️ CRITICAL: INCREMENTAL UPDATES ONLY

**DO NOT rebuild the entire deliverable from scratch!**
- Your previous output exists in files - READ it first
- Only UPDATE sections that have unresolved findings
- SKIP sections that are already approved/resolved
- Write ONLY the changed sections as new deliverable files

**Example workflow:**
1. Previous deliverable had 7 sections across 7 files
2. FindingsRegistry shows 2 sections have unresolved issues (SEC-001 in security, ARCH-001 in architecture)
3. You write ONLY 2 new files: `security-fixes-v2.md` and `architecture-update-v2.md`
4. Reference unchanged files in your summary

## FILE SIZE LIMITS - MANDATORY

Each deliverable file: MAX 4,000 characters (roughly 1,000 tokens)
- If a section exceeds this, split into multiple files
- Use naming like `01-section-part1.md`, `01-section-part2.md`

## Process the FINDINGS REGISTRY

The JSON registry is the SINGLE SOURCE OF TRUTH:
- **SKIP** findings with status=resolved or status=approved
- **ADDRESS** only unresolved findings
- Each finding has: IssueId, category, severity, intent, evidence, proposedFix

## Output Structure

Your response should be:
1. **Resolution Summary** (in your response, not a file):
   - List each IssueId and how you resolved it: `[SEC-001] RESOLVED: Added command allowlist...`
   - For already-resolved items: `[GAP-002] PREVIOUSLY RESOLVED - no action needed`

2. **Updated Files** (via write_deliverable):
   - ONLY files with changes, numbered with version suffix
   - MAX 4,000 chars each

3. **Unchanged Files Reference**:
   - List which previous files remain valid unchanged

## Anti-patterns to AVOID
- ❌ Rewriting the entire report from scratch
- ❌ Creating a single giant consolidated file
- ❌ Re-addressing already-resolved issues
- ❌ Files over 5,000 characters

Your FIRST response should be tool calls to read the FindingsRegistry and your previous files.
...
- **Main** (iter 1, deliverable): `debates/2026-02-03_13-09-44_dfee576f/artifacts/iter-1/003-i1-main-deliverable-code-review-report.md`
- **Main** (iter 1, proposition): `debates/2026-02-03_13-09-44_dfee576f/004-i1-main-proposition.md`
- **Optimistic** (iter 1, review): `debates/2026-02-03_13-09-44_dfee576f/006-i1-optimistic-review.md`
- **Pessimistic** (iter 1, deliverable): `debates/2026-02-03_13-09-44_dfee576f/artifacts/iter-1/008-i1-pessimistic-deliverable-004-i1-critical-review.md`
- **Pessimistic** (iter 1, review): `debates/2026-02-03_13-09-44_dfee576f/009-i1-pessimistic-review.md`
- **FeedbackSummarizer** (iter 1, feedback-summary): `debates/2026-02-03_13-09-44_dfee576f/010-i1-feedbacksummarizer-feedback-summary.md`
- **Main** (iter 1, deliverable): `debates/2026-02-03_13-09-44_dfee576f/artifacts/iter-1/012-i1-main-deliverable-code-review-report.md`
- **Main** (iter 1, proposition): `debates/2026-02-03_13-09-44_dfee576f/013-i1-main-proposition.md`
