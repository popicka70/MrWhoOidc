...
{
    public TokenRequestContext(HttpContext http, string grantType, string clientId, IFormCollection form, OidcOptions options, ITokenService tokens, string? dpopJkt)
    {
        Http = http;
        GrantType = grantType;
        ClientId = clientId;
