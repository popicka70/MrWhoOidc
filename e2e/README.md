...
Tests navigate all pages of the admin UI as a real user would, capture full-page screenshots, and use **GPT-4o Vision** to evaluate UI quality and functional correctness. A comprehensive HTML report is produced after each run.
...
| `ADMIN_USERNAME` | `admin@default.local` | Admin login (seeded automatically on first start) |
