...
public class ProgramSurfaceSnapshotTests
{
    ...
    public void Defined_Rate_Limiting_Policy_Names_Are_Exact_Set()
    {
        ...
        var expected = new[] { "email-discovery", "rl-admin", "rl-authorize", "rl-introspect", "rl-jwks", "rl-par", "rl-qr-cancel", "rl-qr-confirm", "rl-qr-poll", "rl-token", "rl-token-exchange", "rl-userinfo" }.OrderBy(x => x, StringComparer.Ordinal).ToArray();
