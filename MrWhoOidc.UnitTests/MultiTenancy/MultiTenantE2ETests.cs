...
public class MultiTenantE2ETests
{
    ...
    public async Task ClientStore_WithTenantContext_ReturnsOnlyTenantClients()
    {
        ...
        var clientStore = new ClientStore(_db, new DummyHasher(), tenantAccessor, new TestHybridCache(), NullLogger<ClientStore>.Instance, null!);
    ...
    public async Task Clients_WithSameClientId_InDifferentTenants_AreIsolated()
    {
        ...
        var store1 = new ClientStore(_db, new DummyHasher(), accessor1, new TestHybridCache(), NullLogger<ClientStore>.Instance, null!);
        ...
        var store2 = new ClientStore(_db, new DummyHasher(), accessor2, new TestHybridCache(), NullLogger<ClientStore>.Instance, null!);
